...
class RopeProblem {
    ...
    /*Vertex findSplay(Vertex tree, int index) {
        //Vertex node = find(tree, new FindIndex(index));
        if (tree == null)
            return null;
    ...
    class Rope {
        ...
        public Rope(String str) {
            ...
            /*ropeRoot = new Vertex(str.charAt(strLength-1), null, null, null);
            ropeRoot.left = new Vertex(str.charAt(0), null, null, ropeRoot);
            for (int i = 1; i <= strLength-2; i++) {
                Vertex add = new Vertex(str.charAt(i), ropeRoot.left, null, ropeRoot);
                ropeRoot.left.parent = add;
                ropeRoot.left = add;
            }*/
            ...
            /*ropeRoot.print();
            System.out.println();
            Vertex newRoot = findSplay(ropeRoot, 9);
            newRoot.print();*/
        }
